...
{
    move(y++, x);
    printw("               ___                         ___        __________               _            ");
    move(y++, x);
    printw("|\\     |\\     |\\__\\       |\\     |\\       |\\__\\                 \\___|\\ ___\\   | |           ");
    move(y++, x);
    printw("| |    | |    | |  \\      | |    | |      | |  \\          | |                 |_|______     ");
    move(y++, x);
    printw("|_|____| |    |_|___\\     | |____| |      |_|___\\         | |                 |\\ ______\\    ");
    move(y++, x);
...
{
    move(y++, x);
    printw(" _________        ______                             ______                                         _              ");
    move(y++, x);
    printw("|\\______ |\\      /\\_____\\        |\\       /|\\       /\\_____\\                |\\   |\\   |\\           | |             ");
    move(y++, x);
    printw("| |      | |    |\\/      |\\      | \\     / | |     |\\/      |\\              | |  | |  | |          |_|______       ");
    move(y++, x);
    printw("| |      | |    | |      | |     | |\\   / /| |     | |      | |   |           |  | |  | |          |\\ ______\\      ");
    ...
    printw("| |      | |    | |      | |     | | \\ / / | |     | |      | |   |           |  | |  | |          | |      |\\     ");
    move(y++, x);
    printw("| |      | |     \\|_____/\\/      | |  \\ /  | |      \\|_____/\\/              |_|__|_|__|_|___       |_|_____/\\/     ");
    move(y++, x);
    printw(" \\|       \\|      \\_____\\/        \\|        \\|                 \\_____\\/      \\|___\\|___\\|___/      \\______\\/       ");
}

void Exit(int y, int x)
{
    move(y++, x);
    printw(" ____                                           ______       ______                    ");
    move(y++, x);
    printw("|\\ __\\         |\\          |\\    \\     /\\      /\\_____\\               |\\ _____\\        ");
    move(y++, x);
    printw("|_|__/_\\       |_|___      | |    \\   / /     |\\/      |\\   | |                \\       ");
    move(y++, x);
    printw("|\\______\\      |\\_____\\    | |     \\ / /      | |      | |  | |                 \\      ");
    ...
    printw("| |      |\\    | |     |\\  | |     / \\/       | |      | |  | |                 /\\     ");
    move(y++, x);
    printw("|_|_____/\\/    |_|____/\\/  | |    / / \\        \\|_____/\\/             |_|______/ /     ");
    move(y++, x);
    printw("\\_______\\/      \\_____\\/    \\|   /_/   \\        \\_____\\/               \\_______\\/      ");
}
